...
namespace MsConsumers.Infrastructure.Data.Configurations;

public class AddressEntityConfiguration : IEntityTypeConfiguration<AddressEntity>
{
    public void Configure(EntityTypeBuilder<AddressEntity> builder)
    {
        builder.ToTable("tb_consumer_address", "shc_consumer");
        builder.HasKey(e => e.Id);

        builder.Property(e => e.Id).HasColumnName("id").IsRequired();
        builder.Property(e => e.ConsumerId).HasColumnName("consumer_id").IsRequired();
        ...
        builder.HasOne<ConsumerEntity>(e => e.ConsumerEntity)
